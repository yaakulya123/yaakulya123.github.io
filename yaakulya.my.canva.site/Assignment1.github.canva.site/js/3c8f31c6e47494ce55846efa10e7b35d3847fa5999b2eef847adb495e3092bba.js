    ...
    ! function() {
        ...
        e.forEach((e => {
            ...
            if (e.autoplay ? (e.autoplay = !1, e.paused || e.pause(), n.observe(e)) : function(e, t) {
                    ...
                    e.preload = "metadata";
                    const n = t > 0 ? t : .01;
                    e.src = `${e.src}#t=${n}`, a && t > 0 && (e.style.opacity = "0", e.addEventListener("seeked", (() => {
                        e.style.opacity = "1"
                    }), {
                        once: !0
                    }))
            ...
            const l = null !== (o = e.closest(".video_container")) && void 0 !== o ? o : (null !== (i = e.closest("svg")) && void 0 !== i ? i : e).closest("div"),
                {
                    ...
                    i.updateDuration = s, r.appendChild(a),
                        function(e, t) {
                    ...
                    const {
                        ...
                        const i = o.content.firstChild.cloneNode(!0),
                            r = async o => {
                                ...
                                try {
                                    e.paused ? (t(), e.muted && (e.muted = !1), r.style.display = "block", await e.play()) : e.pause()
                                } finally {
                    ...
                    const c = d.querySelector(".pauseSvg"),
                        ...
                        p = () => {
                            d.style.opacity = "0", c.style.display = "block", u.style.display = "none"
                        },
                        v = () => {
                            d.style.opacity = "1", c.style.display = "none", u.style.display = "block"
                        };
                    t.addEventListener("play", p), t.addEventListener("pause", v), t.paused ? v() : p();
                    const h = () => {
                            t.paused || (d.style.opacity = "1"), a.style.opacity = "1"
                        },
                        m = () => {
                            t.paused || (d.style.opacity = "0"), a.style.opacity = "0"
                        };
                    r.addEventListener("mouseenter", h), r.addEventListener("mouseover", h), r.addEventListener("mousemove", h), r.addEventListener("mouseleave", m), r.addEventListener("mouseout", m), r.addEventListener("click", l);
                    return {
                        onResizeCallback: () => {
                            const e = r.clientWidth > 50 && r.clientHeight > 50,
                                t = r.clientWidth > 125 && r.clientHeight > 100;
                            d.style.visibility = e ? "visible" : "hidden", a.style.visibility = t ? "visible" : "hidden"
                        },
                        videoStart: o
                    }
                }(l, e, s, d, r);
